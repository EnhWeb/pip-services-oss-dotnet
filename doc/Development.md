# Development and Testing Guide <br/> Pip.Services OSS for .NET
...
```bash
nuget pack pip-services-oss-dotnet.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices.Oss.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
