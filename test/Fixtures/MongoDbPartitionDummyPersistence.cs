...
{
    public class MongoDbPartitionDummyPersistence : CosmosMongoDbPartitionPersistence<Dummy, string>, IDummyPersistence
    {
        public MongoDbPartitionDummyPersistence()
        ...
        {
            return $"{Math.Abs(id.GetHashCode() % 3)}"; ;
        }
    }
}
