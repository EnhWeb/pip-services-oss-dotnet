...
namespace PipServices.Oss.MongoDb
{
    ...
    public sealed class CosmosMongoDbPartitionPersistenceTest : IDisposable
    {
        private static MongoDbPartitionDummyPersistence Db { get; } = new MongoDbPartitionDummyPersistence();
        private static PersistenceFixture Fixture { get; set; }

        public CosmosMongoDbPartitionPersistenceTest()
        {
